...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'formsdao' => 'getFormsdaoService',
            'formsop' => 'getFormsopService',
            ...
            'placeop' => 'getPlaceopService',
            'placeopdao' => 'getPlaceopdaoService',
            ...
            'security.firewall.map.context.testtoken' => 'getSecurity_Firewall_Map_Context_TesttokenService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/wamp/www/PlacesProject/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/wamp/www/PlacesProject/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/wamp/www/PlacesProject/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/wamp/www/PlacesProject/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'placesdb', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_085eb4e019d3730b57840e74a1041da1');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_085eb4e019d3730b57840e74a1041da1');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_085eb4e019d3730b57840e74a1041da1');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('D:\\wamp\\www\\PlacesProject\\src\\Bundle\\PlacesBundle\\Resources\\config\\doctrine' => 'Bundle\\PlacesBundle\\Entity'));
        ...
        $f->setProxyDir('D:/wamp/www/PlacesProject/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/wamp/www/PlacesProject/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '1ac7dc66bfe373ae669e58d597c1f28549dfd5d0');
    }
    ...
    /**
     * Gets the 'formsdao' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Bundle\PlacesBundle\Service\FormsOperationsDAO A Bundle\PlacesBundle\Service\FormsOperationsDAO instance.
     */
    protected function getFormsdaoService()
    {
        return $this->services['formsdao'] = new \Bundle\PlacesBundle\Service\FormsOperationsDAO($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'formsop' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Bundle\PlacesBundle\Service\FormsOperations A Bundle\PlacesBundle\Service\FormsOperations instance.
     */
    ...
    {
        return $this->services['monolog.formatter.session_request'] = new \Monolog\Formatter\LineFormatter('[%datetime%] %channel%.%level_name%: %message%
');
    }
    ...
    {
        $this->services['monolog.handler.com'] = $instance = new \Monolog\Handler\StreamHandler('D:/wamp/www/PlacesProject/app/logs/com.log', 200, true);
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/wamp/www/PlacesProject/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/wamp/www/PlacesProject/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/wamp/www/PlacesProject/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/wamp/www/PlacesProject/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['search'] = new \Bundle\PlacesBundle\Service\SearchWebService($this->get('searchdao'), $this, $this->get('formsop'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/login$'), 'security.firewall.map.context.testToken' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/testToken$'), 'security.firewall.map.context.admin_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminAreaService()
    {
        ...
        $k = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '1ac7dc66bfe373ae669e58d597c1f28549dfd5d0', 'admin_area', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
        ...
        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($j, array('login_path' => 'login', 'always_use_default_target_path' => true, 'default_target_path' => 'admin_start', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    /**
     * Gets the 'security.firewall.map.context.testtoken' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_TesttokenService()
    {
        return $this->services['security.firewall.map.context.testtoken'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/wamp/www/PlacesProject/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/wamp/www/PlacesProject/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/wamp/www/PlacesProject/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/wamp/www/PlacesProject/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/wamp/www/PlacesProject/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/wamp/www/PlacesProject/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/wamp/www/PlacesProject/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\wamp\\www\\PlacesProject\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('D:\\wamp\\www\\PlacesProject\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('D:\\wamp\\www\\PlacesProject\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('D:\\wamp\\www\\PlacesProject\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('D:\\wamp\\www\\PlacesProject\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('D:\\wamp\\www\\PlacesProject\\src\\Bundle\\PlacesBundle/Resources/views', 'BundlePlaces');
        $instance->addPath('D:\\wamp\\www\\PlacesProject\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('D:\\wamp\\www\\PlacesProject\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('D:/wamp/www/PlacesProject/app/Resources/views');
        $instance->addPath('D:\\wamp\\www\\PlacesProject\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1ac7dc66bfe373ae669e58d597c1f28549dfd5d0');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/wamp/www/PlacesProject/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/wamp/www/PlacesProject/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/wamp/www/PlacesProject/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'D:\\wamp\\www\\PlacesProject\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => 'D:\\wamp\\www\\PlacesProject\\src\\Bundle\\PlacesBundle\\Resources\\config\\validation.yml', 1 => 'D:\\wamp\\www\\PlacesProject\\src\\Bundle\\PlacesBundle\\DependencyInjection/../Resources/config/validation.yml')))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/wamp/www/PlacesProject/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/wamp/www/PlacesProject/app/cache/dev',
            'kernel.logs_dir' => 'D:/wamp/www/PlacesProject/app/logs',
            ...
            'debug.container.dump' => 'D:/wamp/www/PlacesProject/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '1ac7dc66bfe373ae669e58d597c1f28549dfd5d0',
            ...
            'session.save_path' => 'D:/wamp/www/PlacesProject/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'D:\\wamp\\www\\PlacesProject\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => 'D:\\wamp\\www\\PlacesProject\\src\\Bundle\\PlacesBundle\\Resources\\config\\validation.yml',
                1 => 'D:\\wamp\\www\\PlacesProject\\src\\Bundle\\PlacesBundle\\DependencyInjection/../Resources/config/validation.yml',
            ),
            ...
            'profiler.storage.dsn' => 'file:D:/wamp/www/PlacesProject/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/wamp/www/PlacesProject/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/wamp/www/PlacesProject/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/wamp/www/PlacesProject/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/wamp/www/PlacesProject/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/wamp/www/PlacesProject/app/../web',
            'assetic.write_to' => 'D:/wamp/www/PlacesProject/app/../web',
            'assetic.variables' => array(

            ),
            'assetic.java.bin' => 'C:\\Program Files\\Java\\jdk1.7.0_51\\bin\\java.EXE',
            ...
            'doctrine.orm.proxy_dir' => 'D:/wamp/www/PlacesProject/app/cache/dev/doctrine/orm/Proxies',
