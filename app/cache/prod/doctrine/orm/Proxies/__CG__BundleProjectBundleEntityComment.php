 ...
 */
class Comment extends \Bundle\ProjectBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'user', 'approved', 'created', 'updated', 'comment', 'place');
        }
