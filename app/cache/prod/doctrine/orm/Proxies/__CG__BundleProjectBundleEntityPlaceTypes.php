 ...
 */
class PlaceTypes extends \Bundle\ProjectBundle\Entity\PlaceTypes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'placeId', 'typeId', 'main');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PlaceTypes $proxy) {
