...
use Bundle\ProjectBundle\lib\ApiKey;
...
class AuthController extends Controller {
    ...
    public function loginAction(Request $request) {
        ...
        return $this->render('BundleProjectBundle:Login:index.html.twig');
    }

    public function startAction() {
        $user = $this->getUser();
        $userId = $user->getId();
        $userName = $user->getTxtLogin();

        return $this->render('BundleProjectBundle:Login:success.html.twig', array(
                    'userId' => $userId,
                    'userName' => $userName
        ));
    }
